...
public class HuvudprogramVäxt {//huvudklass
    public HuvudprogramVäxt(){//konstruktor
        ...
        Alla objekten ÄR växter OCH en av subklasserna. Kallas Casting. Växt bestämmer vilka metoder vi kan anropa.
        Sublklassen ger oss metodkroppen och konstruktor. Vi borde göra Palm p = new Palm(), MEN jag ville
        visa hur arv fungerar. Allt vi är ute efter är getNamn och getDos och superklassen har dem abstrakt.
        Jag kan inte använda metoden getLängd t ex för dessa objekt då den ej finns
        i superklassen.
         */
